        ...
        *,
        ...
        if blank_diameter_mm is None:
            return CuttingModeResult(
                ...
                is_calculated=False,
                source_note=(
                    "Диаметр заготовки неизвестен (не распознан на чертеже, либо "
                    "заготовка не круглого проката — напр. поковка/отливка, "
                    "типоразмер которой не выражается диаметром) — расчёт режимов "
                    "резания по формуле невозможен без диаметра."
                ),
            )
