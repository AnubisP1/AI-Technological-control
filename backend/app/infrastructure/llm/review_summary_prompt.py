...
резюме отчёта КД (Модуль 1.2) — вынесен отдельно от реализации
провайдера (QwenTextGenerator), чтобы не дублировать и не
рассинхронизировать формулировку антигаллюцинационных ограничений
между реализациями одного порта ITextGenerator.
"""
