...
AI-ассистента по НСИ (Модуль "Обзор") — вынесен отдельно от реализации
провайдера (QwenChatResponder), см. review_summary_prompt.py для
аналогичного паттерна у резюме отчёта КД.
"""
